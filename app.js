...
app.get('/DVP/API/:version/MyAppScopes/MyAppScopes/:console',jwt({secret: secret.Secret}), authorization({resource:"console", action:"read"}), userService.GetMyAppScopesByConsole);
